...
\begin{thm}[代数基本定理的证明]
		...
		\end{align*}
\end{thm}
\begin{thm}[Neo-Hookean superelasiticity model]
		\begin{align*}
...
\begin{thm}[Euler formula of Points  Edges  Regions]
...
\end{thm}
\begin{thm}[Laplace Transformation  拉普拉斯变换]
